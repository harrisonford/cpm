...
import internal.cpm as cpm
import os
os.environ['CUDA_VISIBLE_DEVICES'] = '1'


LIMBS = np.array([1, 2, 3, 4, 4, 5, 6, 7, 7, 8, 9, 10, 10, 11, 12, 13, 13, 14]).reshape((-1, 2)) - 1
COLORS = [[0, 0, 255], [0, 170, 255], [0, 255, 170], [0, 255, 0], [170, 255, 0], [255, 170, 0], [255, 0, 0],
          [255, 0, 170], [170, 0, 255]]


def detect_objects_heatmap(heatmap):

    data = 256 * heatmap  # 0-1 to 0-256
...
def main():
    ...
    # get the cpm pretrained model
    model_path = '/home/babybrain/Descargas/'
    ...
    hmap_pose = sess.run(heatmap_pose, feed_dict)

    parts = detect_parts_heatmaps(hmap_pose, centers, [h, w])
